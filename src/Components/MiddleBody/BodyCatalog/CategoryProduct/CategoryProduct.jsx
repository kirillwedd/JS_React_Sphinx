  ...
  return (
    <div className="wrapper">
      ...
      <div className="sliders">
        <div className="progress" style={{left: `${minLeft +"%"}`, right:`${minRight + "%"}`}}></div>
      </div>
      <div className="range-input">
        <input type="range" className="range-min" min={0} max={10000} step={1} value={minValue} onChange={onChangeHandlerRange1}   />
